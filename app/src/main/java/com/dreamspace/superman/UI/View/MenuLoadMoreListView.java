 ...
 */
public class MenuLoadMoreListView extends SwipeMenuListView implements OnScrollListener{
    private static final String TAG =com.dreamspace.superman.UI.View.MenuLoadMoreListView.class
            .getSimpleName();
    ...
    public MenuLoadMoreListView(Context context) {
        super(context);
        init(context);
    }

    public MenuLoadMoreListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);

    }

    public MenuLoadMoreListView(Context context, AttributeSet attrs, int defStyle) {
